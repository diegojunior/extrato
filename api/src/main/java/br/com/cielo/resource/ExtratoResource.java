...
public class ExtratoResource {
	...
	@ApiOperation(value = "lancamentos", nickname = "Lancamentos")
	public ResponseEntity<List<ControleLancamentoJson>> lancamentos(
			@PathVariable(value = "indice") final String indiceParam,
		...
		return new ResponseEntity<List<ControleLancamentoJson>>(extratoJson.getListaControleLancamento(),
				HttpStatus.OK);
	}
